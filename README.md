...
Copie o arquivo de exemplo e adicione sua chave do Google Gemini:

```bash
cp .env.example .env
```

Edite o `.env` e substitua `your_api_key_here` pela sua chave, obtida em [aistudio.google.com](https://aistudio.google.com/).
